...
# ==============================================================================
# SEGMENT 3 OF 9: SIDEBAR LAYOUT CONFIG & API CONNECTION INITIALIZATION
# ==============================================================================
    ...
    if not api_token_input:
        ...
        with st.spinner("Connecting to servers... Executing Volumetric Background Extraction..."):
            try:
                ...
                # ==============================================================================
# SEGMENT 4 OF 9: API QUOTA EXTRACTION, TELEMETRY MAPPING & HARD DRIVE DISK STORAGE
# ==============================================================================

# This block executes if a response has been generated by the server layout
if api_sync_triggered and 'api_response' in locals() and api_response is not None:
    try:
